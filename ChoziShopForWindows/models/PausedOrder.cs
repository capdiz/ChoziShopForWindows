...
{
    public class PausedOrder : INotifyPropertyChanged
    {

        public PausedOrder(Order order)
        {
            PausedOrderId = order.Id;
        ...
        private int _pausedOrderId;
        public int PausedOrderId
        {
            get => _pausedOrderId;
            set
            {
                if (_pausedOrderId != value)
                {
                    _pausedOrderId = value;
                    OnPropertyChanged();
                }
            }
        }
